...
export class BookingComponent implements OnInit {
  ...
  constructor(public orgnigation:OrgnigationService,private activatedroute: ActivatedRoute,private router: Router) { 
  ...
  user:any=[];loging:any=false;nodata:String="";
  fetchData(){
  ...
  edite(pos:any){
    localStorage.setItem("booking",JSON.stringify(this.user[pos]));
